...
public:
    ...
    static Matrix4 CreateRotationX(float theta)
    {
		...
		temp[1][1] = (float)cos(theta);
		temp[1][2] = (float)sin(theta);
		temp[2][1] = (float)(-1 * sin(theta));
		temp[2][2] = (float)cos(theta);
    ...
    static Matrix4 CreateRotationY(float theta)
    {
		...
		temp[0][0] = (float)cos(theta);
		temp[0][2] = (float)(-1 * sin(theta));
		temp[2][0] = (float)sin(theta);
		temp[2][2] = (float)cos(theta);
    ...
    static Matrix4 CreateRotationZ(float theta)
    {
		...
		temp[0][0] = (float)cos(theta);
		temp[0][1] = (float)sin(theta);
		temp[1][0] = (float)(-1 * sin(theta));
		temp[1][1] = (float)cos(theta);
...
{
	// TODO Lab 01e
	float x = vec.x * mat.mat[0][0] + vec.y * mat.mat[1][0] + vec.z * mat.mat[2][0] + w * mat.mat[3][0];
	float y = vec.x * mat.mat[0][1] + vec.y * mat.mat[1][1] + vec.z * mat.mat[2][1] + w * mat.mat[3][1];
	float z = vec.x * mat.mat[0][2] + vec.y * mat.mat[1][2] + vec.z * mat.mat[2][2] + w * mat.mat[3][2];
	return Vector3(x, y, z);
}
...
{
	// TODO Lab 01e
	float x = vec.x * mat.mat[0][0] + vec.y * mat.mat[1][0] + vec.z * mat.mat[2][0] + vec.w * mat.mat[3][0];
	float y = vec.x * mat.mat[0][1] + vec.y * mat.mat[1][1] + vec.z * mat.mat[2][1] + vec.w * mat.mat[3][1];
	float z = vec.x * mat.mat[0][2] + vec.y * mat.mat[1][2] + vec.z * mat.mat[2][2] + vec.w * mat.mat[3][2];
	float w = vec.x * mat.mat[0][3] + vec.y * mat.mat[1][3] + vec.z * mat.mat[2][3] + vec.w * mat.mat[3][3];
